...
$GLOBALS['TL_LANG']['tl_module']['srl_set_closePerLayerClick']        = array('Schließen des Layers per Klick auf den Overlay-Breich ','wenn dieses Feld deaktiviert wird, kann der Besucher den Seite den Layer nicht mehr per Klick auf denOverlay-bereich zu schließen');
